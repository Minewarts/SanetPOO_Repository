        ...
        try:
            ...
            with open("usuarios.txt", "w", encoding="utf-8") as f:
                for u in self.__clientes:
                    ...
                    productos_ids = ";".join([p.getId() for p in u.GetListaProductos if p.getId()])
                    mascotas_ids = ";".join([m.getId() for m in u.GetListaMascotas if m.getId()])
            ...
            try:
                with open("usuarios.txt", "r", encoding="utf-8") as f:
                    for linea in f:
                        ...
                        nombre, productos_ids_str, mascotas_ids_str = partes
                        usuario = Usuarios(nombre)
                        

                        if productos_ids_str: 
                            for pid in productos_ids_str.split(";"):
                                for p in self.__productos:
                                    if p.getId() == pid:
                        ...
                        if mascotas_ids_str: 
                            for mid in mascotas_ids_str.split(";"):
                                for m in self.__mascotas:
                                    if m.getId() == mid:
